...
- [Blog 基础升级与站点复验](work/2026-09-04-http-result-contract/index.md)：下次从 Blog 开始用户复验；基础迁移已完成。

- **Focus:** [开发者令牌一键投稿](work/2026-09-12-personal-token-publishing/index.md)：13 项权限及投稿验收通过；构建/部署配置已补齐，Foundation 固定候选通过独立验收，正式发布待明确授权。
