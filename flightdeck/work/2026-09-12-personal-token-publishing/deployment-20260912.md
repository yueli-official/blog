...
所属仓库：blog。状态：本轮服务器更新完成；不表示本 Work 的正式 SDK 发布等其他门禁完成。

- 固定候选源码 HEAD：`311940650442cc80175c3e47209a160f96747999`；未提交改动通过逐文件 SHA256 与补丁归档，包括 Blog/WWW PAT 和 Foundation 编辑器按钮居中修复。
